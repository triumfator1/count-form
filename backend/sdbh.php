...
class sdbh {
	 ...
	 * @return array query result as array of rows, each an associative array
	 */
  ...
  public function getTariffField($price) :array|null
  {   
    $tarifField = $this->mselect_rows(
      'a25_products',
      ['PRICE' => $price],
      0,
      1,
    ...
    return $tarifField ? unserialize($tarifField) : $tarifField;
  }
}
